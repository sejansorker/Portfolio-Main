        ...
        <div className="lg:flex ">
          ...
          <div className="lg:w-2/3 w-full lg:static fixed bottom-0 left-0 right-0 z-50 pb-[env(safe-area-inset-bottom)]">
            <div className="flex lg:justify-end justify-center ">
              <ul className='flex justify-center lg:gap-x-10 gap-x-8 w-full bg-[rgba(27,27,27)] lg:bg-none border-b-1 border-l-1 lg:border-amber-500 lg:py-6 py-4 lg:px-20  lg:rounded-tr-[30px] lg:rounded-bl-[30px]'>
