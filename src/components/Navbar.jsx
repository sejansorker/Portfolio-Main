     ...
     <div className="overflow-hidden ">
      <Container>
        <div className="flex ">
          ...
          <div className="lg:w-2/3 w-full lg:static fixed bottom-0 left-0 z-50 m-0 p-0">
            <div className="flex lg:justify-end justify-center">
              <ul className='flex lg:gap-x-8 gap-x-5 bg-[rgba(27,27,27)] lg:bg-[rgba(137,137,137,0.11)] lg:py-6 py-10 lg:px-20 px-[51px] lg:rounded-tr-[30px] lg:rounded-bl-[30px]'>
